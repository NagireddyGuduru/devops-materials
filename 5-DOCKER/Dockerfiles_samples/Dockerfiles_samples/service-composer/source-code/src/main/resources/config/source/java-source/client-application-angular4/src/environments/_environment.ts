...
export const environment = {
  ...
  oauth2TokenUri: 'http://localhost:8000/auth-service/oauth/token',
  oauth2ClientAppName: 'demo-client-app',
  oauth2ClientAppSecret: 'secret',
  oauth2UserInfoUri: 'http://localhost:8000/auth-service/user/me',
  // <block-oauth2-authorization-service-end>
  // <block-micro-frontends-start>
  microFrontendAppsUri: 'http://localhost:4201/#/dashboard'
