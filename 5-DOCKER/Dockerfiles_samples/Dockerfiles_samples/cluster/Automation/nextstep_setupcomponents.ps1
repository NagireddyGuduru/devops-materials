...
function ReadandExectuteComponetsfromJsontoK8sCluster
{
  ...
  $res= Import-LocalizedData -BaseDirectory $general.k8s_resource_module_folder -FileName $general.k8s_resource_module_file
   ...
   #deploying nextstep_nsngnix_Initialcomponents 
   $nextstepnsngnixInitialcomponents=$json.nextstep_nsngnix_Initialcomponents 
   ReadandExectuteComponetsfromJsontoK8sCluster $nextstepnsngnixInitialcomponents  -folderpath $general.k8s_setupcomponents_folder -compname $res.10029

   #deploying nextstep_nsngninx_components
   $nextstepnsngninxcomponents=$json.nextstep_nsngninx_components
   ReadandExectuteComponetsfromJsontoK8sCluster $nextstepnsngninxcomponents  -folderpath $general.k8s_setupcomponents_folder -compname $res.10030

   #nextstep_nginix_certiciate 
  # $nextstepnginixcerticiate=$json.nextstep_nginix_certiciate 
   #ReadandExectuteComponetsfromJsontoK8sCluster $nextstepnginixcerticiate  -folderpath $general.k8s_setupcomponents_folder -compname $res.10031
